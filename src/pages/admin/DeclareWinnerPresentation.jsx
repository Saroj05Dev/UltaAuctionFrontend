// Presentational Component: DeclareWinnerPresentation.jsx
import React from "react";
import { Card, CardContent } from "../../components/ui/Card";
import { Loader2 } from "lucide-react";

const DeclareWinnerPresentation = ({ auctions, loading, handleDeclareWinner }) => {
  return (
    <div className="p-6">
                  ...
                  <button
                    ...
                    disabled={
                      ...
                      !(auction.status === "completed" ||
                        auction.slotsFilled >= auction.maxSlots)
                    }
...
export default DeclareWinnerPresentation;
